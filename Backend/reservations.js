...
router.post('/reserve', async (req, res) => {
    ...
    // Call Rust service
    const conflict = await axios.post('rust-service-production.up.railway.app/check-conflict', { room, time });
...
router.get('/reservations', async (req, result) => {
    try {
    const res = await fetch('http://rust-service-production.up.railway.app/get-reservations-list');
